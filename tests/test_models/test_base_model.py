...
class TestBaseModel(unittest.TestCase):
    ...
    def test_str(self):
        ...
        class_name = f"[{self.base_model.__class__.__name__}]"
        id_str = f" ({self.base_model.id})"
        attrs_str = f"{self.base_model.__dict__}"
        expected_string = class_name + id_str + attrs_str
